class Overworld extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('slime', 'slime.png', { frameWidth: 16,
            frameHeight: 16 })
    ...
    create() {
        ...
        const bgLayer = map.createLayer('Background', tileset, 0,)
        const terrainLayer = map.createLayer('Terrain', tileset, 0,)
        ...
        this.physics.world.bounds.setTo(0, 0, map.widthInPixels,
            map.heightInPixels)
